Return-Path: <linux-alpha+bounces-3726-lists+linux-alpha=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-alpha@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id US4OLMonSGrhmwAAu9opvQ
	(envelope-from <linux-alpha+bounces-3726-lists+linux-alpha=lfdr.de@vger.kernel.org>)
	for <lists+linux-alpha@lfdr.de>; Fri, 03 Jul 2026 23:21:14 +0200
X-Original-To: lists+linux-alpha@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id EDBBF705B67
	for <lists+linux-alpha@lfdr.de>; Fri, 03 Jul 2026 23:21:13 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=zytor.com header.s=2026062701 header.b=XsI115ZB;
	dmarc=pass (policy=none) header.from=zytor.com;
	spf=pass (mail.lfdr.de: domain of "linux-alpha+bounces-3726-lists+linux-alpha=lfdr.de@vger.kernel.org" designates 2600:3c0a:e001:db::12fc:5321 as permitted sender) smtp.mailfrom="linux-alpha+bounces-3726-lists+linux-alpha=lfdr.de@vger.kernel.org";
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 9A9EF300CC15
	for <lists+linux-alpha@lfdr.de>; Fri,  3 Jul 2026 21:21:12 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 318FB31F9A5;
...
X-Spamd-Result: default: False [0.54 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-3726-lists,linux-alpha=lfdr.de];
	...
	FORGED_SENDER(0.00)[hpa@zytor.com,linux-alpha@vger.kernel.org];
	MIME_TRACE(0.00)[0:+];
 ...
 lists.infradead.org,s:lists@lfdr.de];
	...
	FROM_NEQ_ENVFROM(0.00)[hpa@zytor.com,linux-alpha@vger.kernel.org];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[sea.lore.kernel.org:helo,sea.lore.kernel.org:rdns,vger.kernel.org:from_smtp,zytor.com:from_mime,zytor.com:dkim,zytor.com:mid]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: EDBBF705B67
