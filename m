Return-Path: <linux-alpha+bounces-3793-lists+linux-alpha=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-alpha@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id d+PTHzgLT2qjZgIAu9opvQ
	(envelope-from <linux-alpha+bounces-3793-lists+linux-alpha=lfdr.de@vger.kernel.org>)
	for <lists+linux-alpha@lfdr.de>; Thu, 09 Jul 2026 04:45:12 +0200
X-Original-To: lists+linux-alpha@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [IPv6:2600:3c09:e001:a7::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 61A5672C1C7
	for <lists+linux-alpha@lfdr.de>; Thu, 09 Jul 2026 04:45:12 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=huawei.com header.s=dkim header.b=vWAJv97f;
	dmarc=pass (policy=quarantine) header.from=huawei.com;
	spf=pass (mail.lfdr.de: domain of "linux-alpha+bounces-3793-lists+linux-alpha=lfdr.de@vger.kernel.org" designates 2600:3c09:e001:a7::12fc:5321 as permitted sender) smtp.mailfrom="linux-alpha+bounces-3793-lists+linux-alpha=lfdr.de@vger.kernel.org";
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id CDE81301F8F3
	for <lists+linux-alpha@lfdr.de>; Thu,  9 Jul 2026 02:45:11 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 94608346FD2;
...
X-Spamd-Result: default: False [-9.16 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-3793-lists,linux-alpha=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
