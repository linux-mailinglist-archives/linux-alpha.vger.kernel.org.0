Return-Path: <linux-alpha+bounces-3716-lists+linux-alpha=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-alpha@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id WunUFnjjQ2pBlAoAu9opvQ
	(envelope-from <linux-alpha+bounces-3716-lists+linux-alpha=lfdr.de@vger.kernel.org>)
	for <lists+linux-alpha@lfdr.de>; Tue, 30 Jun 2026 17:40:40 +0200
X-Original-To: lists+linux-alpha@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [172.232.135.74])
	by mail.lfdr.de (Postfix) with ESMTPS id EB9F96E6055
	for <lists+linux-alpha@lfdr.de>; Tue, 30 Jun 2026 17:40:39 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	...
	spf=pass (mail.lfdr.de: domain of "linux-alpha+bounces-3716-lists+linux-alpha=lfdr.de@vger.kernel.org" designates 172.232.135.74 as permitted sender) smtp.mailfrom="linux-alpha+bounces-3716-lists+linux-alpha=lfdr.de@vger.kernel.org";
	dmarc=pass (policy=none) header.from=linutronix.de;
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id BB6FA3030D27
	for <lists+linux-alpha@lfdr.de>; Tue, 30 Jun 2026 15:32:11 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 058E2441031;
...
X-Spamd-Result: default: False [7.34 / 15.00];
 ...
 de];
	...
	TAGGED_FROM(0.00)[bounces-3716-lists,linux-alpha=lfdr.de];
	FROM_HAS_DN(0.00)[];
