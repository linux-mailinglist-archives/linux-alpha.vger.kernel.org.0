Return-Path: <linux-alpha+bounces-3720-lists+linux-alpha=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-alpha@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id UjNrJreIR2owaQAAu9opvQ
	(envelope-from <linux-alpha+bounces-3720-lists+linux-alpha=lfdr.de@vger.kernel.org>)
	for <lists+linux-alpha@lfdr.de>; Fri, 03 Jul 2026 12:02:31 +0200
X-Original-To: lists+linux-alpha@lfdr.de
Received: from sin.lore.kernel.org (sin.lore.kernel.org [IPv6:2600:3c15:e001:75::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id B0F77700ED1
	for <lists+linux-alpha@lfdr.de>; Fri, 03 Jul 2026 12:02:30 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=arm.com header.s=foss header.b=S7QhjRah;
	dmarc=pass (policy=none) header.from=arm.com;
	spf=pass (mail.lfdr.de: domain of "linux-alpha+bounces-3720-lists+linux-alpha=lfdr.de@vger.kernel.org" designates 2600:3c15:e001:75::12fc:5321 as permitted sender) smtp.mailfrom="linux-alpha+bounces-3720-lists+linux-alpha=lfdr.de@vger.kernel.org";
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sin.lore.kernel.org (Postfix) with ESMTP id 3A7BE300441B
	for <lists+linux-alpha@lfdr.de>; Fri,  3 Jul 2026 10:00:45 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B462C3B71C1;
...
X-Spamd-Result: default: False [-1.66 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-3720-lists,linux-alpha=lfdr.de];
	FROM_HAS_DN(0.00)[];
	FORGED_SENDER(0.00)[mark.rutland@arm.com,linux-alpha@vger.kernel.org];
	MIME_TRACE(0.00)[0:+];
 ...
 sts.infradead.org,s:lists@lfdr.de];
	...
	FROM_NEQ_ENVFROM(0.00)[mark.rutland@arm.com,linux-alpha@vger.kernel.org];
