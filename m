Return-Path: <linux-alpha+bounces-3724-lists+linux-alpha=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-alpha@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id Nhu0Hh6mR2qfcwAAu9opvQ
	(envelope-from <linux-alpha+bounces-3724-lists+linux-alpha=lfdr.de@vger.kernel.org>)
	for <lists+linux-alpha@lfdr.de>; Fri, 03 Jul 2026 14:07:58 +0200
X-Original-To: lists+linux-alpha@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id EB04A70230F
	for <lists+linux-alpha@lfdr.de>; Fri, 03 Jul 2026 14:07:57 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=arm.com header.s=foss header.b=BzvOXcJ3;
	dmarc=pass (policy=none) header.from=arm.com;
	spf=pass (mail.lfdr.de: domain of "linux-alpha+bounces-3724-lists+linux-alpha=lfdr.de@vger.kernel.org" designates 172.234.253.10 as permitted sender) smtp.mailfrom="linux-alpha+bounces-3724-lists+linux-alpha=lfdr.de@vger.kernel.org";
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 438EC30022BE
	for <lists+linux-alpha@lfdr.de>; Fri,  3 Jul 2026 11:59:50 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1D99F3CC7D6;
...
X-Spamd-Result: default: False [-2.16 / 15.00];
	...
	FORGED_SENDER(0.00)[kevin.brodsky@arm.com,linux-alpha@vger.kernel.org];
	MIME_TRACE(0.00)[0:+];
	...
	TAGGED_FROM(0.00)[bounces-3724-lists,linux-alpha=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
 ...
 ts.infradead.org,s:lists@lfdr.de];
	...
	FROM_NEQ_ENVFROM(0.00)[kevin.brodsky@arm.com,linux-alpha@vger.kernel.org];
