Return-Path: <linux-alpha+bounces-3717-lists+linux-alpha=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-alpha@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id LbcjB1zyQ2r/lwoAu9opvQ
	(envelope-from <linux-alpha+bounces-3717-lists+linux-alpha=lfdr.de@vger.kernel.org>)
	for <lists+linux-alpha@lfdr.de>; Tue, 30 Jun 2026 18:44:12 +0200
X-Original-To: lists+linux-alpha@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id BFCA36E693D
	for <lists+linux-alpha@lfdr.de>; Tue, 30 Jun 2026 18:44:11 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=arm.com header.s=foss header.b=IGK2WudX;
	spf=pass (mail.lfdr.de: domain of "linux-alpha+bounces-3717-lists+linux-alpha=lfdr.de@vger.kernel.org" designates 172.105.105.114 as permitted sender) smtp.mailfrom="linux-alpha+bounces-3717-lists+linux-alpha=lfdr.de@vger.kernel.org";
	dmarc=pass (policy=none) header.from=arm.com;
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id F227D3028E87
	for <lists+linux-alpha@lfdr.de>; Tue, 30 Jun 2026 16:37:57 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 31E0837EFE5;
...
X-Spamd-Result: default: False [-2.16 / 15.00];
	...
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-3717-lists,linux-alpha=lfdr.de];
 ...
 @lists.infradead.org,s:lists@lfdr.de];
	FORGED_SENDER(0.00)[ada.coupriediaz@arm.com,linux-alpha@vger.kernel.org];
	TO_DN_SOME(0.00)[];
	...
	FROM_NEQ_ENVFROM(0.00)[ada.coupriediaz@arm.com,linux-alpha@vger.kernel.org];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[huawei.com:email,arm.com:dkim,arm.com:email,arm.com:mid,arm.com:from_mime,vger.kernel.org:from_smtp,tor.lore.kernel.org:rdns,tor.lore.kernel.org:helo]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: BFCA36E693D
